function [precision, recall, cmat,predFinalQueryImg ] = svm(numOfReturnedImgs, dataset, queryImageFeatureVector, metric, folder_name, img_ext)
...
for k = 0:length(lbls)-1
    ...
    elseif (img_names(k+1) > 199 && img_names(k+1) <= 299)
        lbls(k+1) = 3;
    elseif (img_names(k+1) > 299 && img_names(k+1) <= 379)
        lbls(k+1) = 4;
    elseif (img_names(k+1) > 379 && img_names(k+1) <= 430)
        lbls(k+1) = 5;
    elseif (img_names(k+1) > 430 && img_names(k+1) <= 510)
        lbls(k+1) = 6;
    elseif (img_names(k+1) > 510 && img_names(k+1) <= 590)
        lbls(k+1) = 7;
    elseif (img_names(k+1) > 590 && img_names(k+1) <= 670)
        lbls(k+1) = 8;
    elseif (img_names(k+1) > 670 && img_names(k+1) <= 750)
        lbls(k+1) = 9;
    elseif (img_names(k+1) > 750 && img_names(k+1) <= 830)
        lbls(k+1) = 10;
    elseif (img_names(k+1) > 830 && img_names(k+1) <= 880)
        lbls(k+1) = 11;
    elseif (img_names(k+1) > 880 && img_names(k+1) <= 931)
        lbls(k+1) = 12;
...
[trainIdx testIdx] = crossvalind('HoldOut', lbls,0.6); % split the train and test labels 50%-50%
